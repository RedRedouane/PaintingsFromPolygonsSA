...
import numpy as np
from algorithms2 import Algorithm, Hillclimber, SA, PPA
import time
import math
import os
import csv
...
paintins = ["paintings/mondriaan2-180-240.png", "paintings/starrynight-240-180.png"]
...
names = ["c500_test_5k_i_2_poly_OC"]
...
if __name__ == '__main__':
	...
	for i in range(worker_count):
		args = (names[i], "SA", paintins, repetitions, polys, iterations, savepoints)
